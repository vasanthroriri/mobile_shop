...
session_start();
    ...
    $model_result = productTypeAll(); // Call the function to fetch universities 
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <?php include "formProductType.php";?> <!---add Student popup--->
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <div class="d-flex flex-wrap gap-2">
                                        ...
                                        <i class="bi bi-plus-square"></i>  Product Type
                                        </button>
                                    </div>
                                </div>
                                <h3 class="page-title">Product Type List</h3>   
                            </div>
                        </div>
                    </div>
...
function editelective(editId) {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#productNameEdit').val(response.pro_id);
            $('#productTypeEdit').val(response.name);
...
$('#addModel').submit(function(event) {
    ...
    $.ajax({
        ...
        error: function(jqXHR, textStatus, errorThrown) {
            alert('Error adding Product Type: ' + textStatus);
        },
        complete: function() {
