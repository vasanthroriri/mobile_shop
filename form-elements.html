...
<head>
    <meta charset="utf-8" />
    <title>Form Elements | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Floating labels</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Horizontal form</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Horizontal form label sizing</h4>
