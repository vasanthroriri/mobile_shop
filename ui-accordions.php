...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Accordions | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                        <h4 class="fs-16">Default Accordions</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                        <h4 class="fs-16">Flush Accordions</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                        <h4 class="fs-16">Simple Card Accordions</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                        <h4 class="fs-16">Always Open Accordions</h4>
