...
<head>
    <meta charset="utf-8" />
    <title>Apex Scatter Charts | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Scatter (XY) Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Scatter Chart - Datetime</h4>
                                <div dir="ltr">
                    ...
                    <div class="row mb-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Scatter - Images</h4>
                                <div dir="ltr">
