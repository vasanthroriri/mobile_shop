...
<head>
    <meta charset="utf-8" />
    <title>Form Advanced | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Date Range Picker</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Bootstrap Datepicker</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Flatpickr - Date picker</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Flatpickr - Time Picker </h4>
                                <p class="text-muted fs-14">A lightweight and powerful datetimepicker</p>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Bootstrap Touchspin</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Bootstrap Maxlength</h4>
                                <p class="text-muted fs-14">
