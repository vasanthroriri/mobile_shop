...
<head>
    <meta charset="utf-8" />
    <title>Google Maps | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Basic Google Map</h4>
                                <div id="gmaps-basic" class="gmaps"></div>
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Markers Google Map</h4>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Street View Panoramas Google Map</h4>
                                <div id="panorama" class="gmaps"></div>
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Google Map Types</h4>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Ultra Light with Labels</h4>
