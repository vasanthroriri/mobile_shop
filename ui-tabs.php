...
<head>
    <meta charset="utf-8" />
    <title>Tabs | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Default Tabs</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Tabs Justified</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Tabs Vertical Left</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Tabs Vertical Right</h4>
                                <p class="text-muted fs-14 mb-3">
                                    You can stack your navigation by changing the flex item direction with the <code>.flex-column</code> utility.
                                </p>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Tabs Bordered</h4>
                                <p class="text-muted fs-14 mb-3">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Tabs Bordered Justified</h4>
                                <p class="text-muted fs-14 mb-3">
