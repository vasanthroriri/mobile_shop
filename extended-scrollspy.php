...
<head>
    <meta charset="utf-8" />
    <title>Scrollspy | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Example in navbar</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Example with nested nav</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Example with list-group</h4>
                                <p class="text-muted fs-14">Scrollspy also works with nested <code>.nav</code>s.
                                    If a nested <code>.nav</code> is <code>.active</code>, its parents will also be
                                    <code>.active</code>. Scroll the area next to the navbar and watch the active
                                    class change.
