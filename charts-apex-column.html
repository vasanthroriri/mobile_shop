...
<head>
    <meta charset="utf-8" />
    <title>Apex Column Charts | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Basic Column Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Column Chart with Datalabels</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Stacked Column Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">100% Stacked Column Chart</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Column with Markers</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Column with Group Label</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Column Chart with rotated labels & Annotations</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Column Chart with negative values</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Distributed Column Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Range Column Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                <div class="d-flex card-header justify-content-between align-items-center">
                                    <h4 class="fs-16">Dynamic Loaded Chart</h4>
                                    <div class="flex-shrink-0">
