...
<head>
    <meta charset="utf-8" />
    <title>Basic Tables | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                ...
                                <h4 class="fs-16">Inverse table</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                ...
                                <h4 class="fs-16">Striped rows</h4>
                                <p class="text-muted fs-14">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                ...
                                <h4 class="fs-16">Table head options</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Hoverable rows</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Bordered table</h4>
                                <p class="text-muted fs-14">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Bordered color table</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                ...
                                <h4 class="fs-16">Always responsive</h4>
                                <p class="text-muted fs-14">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                ...
                                <h4 class="fs-16">Basic Borderless Example</h4>
                                <p class="text-muted fs-14">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                ...
                                <h4 class="fs-16">Inverse Borderless table</h4>
                                <p class="text-muted fs-14">
                                    Add <code>.table-borderless</code> for a table without borders.
                                </p>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Active tables</h4>
                                <p class="text-muted fs-14">
