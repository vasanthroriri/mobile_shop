...
<head>
    <meta charset="utf-8" />
    <title>Badges | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Contextual variations</h4>
                                <p class="text-muted fs-14 mb-3">
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Badge Positioned</h4>
                                <p class="text-muted fs-14 mb-3">
