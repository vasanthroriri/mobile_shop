...
<head>
    <meta charset="utf-8" />
    <title>Buttons | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Default Buttons</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Button-Rounded</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Soft Buttons</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Button-Sizes</h4>
                                <p class="text-muted">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Button Outline</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Button Outline Rounded</h4>
                                <p class="text-muted">Use a classes <code>.btn-outline-**</code> to quickly create a bordered buttons.</p>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Soft Rounded Buttons</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Button-Disabled</h4>
                                <p class="text-muted">
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Block Button</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Button Group</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Toggle Button</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16 mt-4">Button tags</h4>
