...
<head>
    <meta charset="utf-8" />
    <title>Carousel | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h4 class="fs-16">With Controls</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h4 class="fs-16">With Indicators</h4>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h4 class="fs-16">With Captions</h4>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Individual Interval</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-lg-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Dark variant</h4>
