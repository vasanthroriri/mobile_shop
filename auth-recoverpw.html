...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Recover Password | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
                    ...
                    <div class="col-xxl-6 col-lg-5">
                        ...
                        <div class="card bg-transparent mb-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="w-75">
                                    <h4 class="text-dark-50 mt-0 fw-bold">Reset Password</h4>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p class="text-muted bg-body">Back to <a href="auth-login.html" class="text-muted ms-1 link-offset-3 text-decoration-underline"><b>Log In</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
