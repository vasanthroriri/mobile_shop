...
<head>
    <meta charset="utf-8" />
    <title>Vector Maps | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">World Vector Map</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">USA Vector Map</h4>
                                <div id="usa-vectormap" style="height: 300px"></div>
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">India Vector Map</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Australia Vector Map</h4>
                                <div id="australia-vectormap" style="height: 300px"></div>
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Chicago Vector Map</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">UK Vector Map</h4>
                                <div id="uk-vectormap" style="height: 300px"></div>
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Canada Vector Map</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Europe Vector Map</h4>
                                <div id="europe-vectormap" style="height: 300px"></div>
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">France Vector Map</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Spain Vector Map</h4>
