...
<head>
    <meta charset="utf-8" />
    <title>Apex RadialBar Charts | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Basic RadialBar Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Multiple RadialBars</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Circle Chart - Custom Angle</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Circle Chart with Image</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Stroked Circular Guage</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Gradient Circular Chart</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Semi Circle Gauge</h4>
                                <div dir="ltr">
