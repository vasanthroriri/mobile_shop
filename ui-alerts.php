...
<head>
    <meta charset="utf-8" />
    <title>Alerts | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Default Alert</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Dismissing Alerts</h4>
                                <p class="text-muted fs-14 mb-3">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Custom Alerts</h4>
                                <p class="text-muted fs-14 mb-3">
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Icons with Alerts</h4>
                                <p class="text-muted fs-14 mb-3">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Additional content</h4>
                                <p class="text-muted fs-14 mb-3">
