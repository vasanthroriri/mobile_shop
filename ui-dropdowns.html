...
<head>
    <meta charset="utf-8" />
    <title>Dropdowns | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Single button dropdowns</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Animated Dropdown</h4>
                                <p class="text-muted font-14">
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Dropup variation</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Dropend variation</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Disabled Item</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Dark dropdowns</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Dropdown options</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Menu alignment</h4>
                                <p class="text-muted font-14">
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Split button dropdowns</h4>
                                <p class="text-muted font-14">
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Dropstart variation</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Centered dropdowns</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Auto close behavior</h4>
