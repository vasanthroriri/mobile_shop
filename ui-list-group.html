...
<head>
    <meta charset="utf-8" />
    <title>List Group | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Basic example</h4>
                        ...
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Active items</h4>
                        ...
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Disabled items</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Links and Buttons</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Contextual classes</h4>
                        ...
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Contextual classes with Link</h4>
                                <p class="text-muted fs-14">Use contextual classes to style list items with a
                                    stateful background and color.</p>
                        ...
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Custom content</h4>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-xl-4">
                            <div class="mb-4">
                                <h4 class="fs-16">Checkboxes and radios</h4>
                                ...
                                <ol class="list-group list-group-numbered">
                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold">Powerx Admin</div>
                                            Powerx Admin
                                        </div>
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-start">
                                        <div class="ms-2 me-auto">
                                            <div class="fw-bold">Powerx React Admin</div>
                                            Powerx React Admin
                                        </div>
