...
<head>
    <meta charset="utf-8" />
    <title>Apex Candlestick Charts | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Simple Candlestick Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Combo Candlestick Chart</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Category X-Axis</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-3">Candlestick with Line</h4>
                                <div dir="ltr">
