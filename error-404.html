...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Error 404 | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
                        ...
                        <div class="card bg-transparent mb-0">
                            ...
                            <div class="card-body p-4">
                                <div class="">
                                    ...
                                    <a class="btn btn-primary w-100 mt-3" href="index.html"><i class="ri-home-4-line"></i> Back to Home</a>
                                </div>
                            </div> <!-- end card-body-->
                        </div>
                        <!-- end card -->
