...
<head>
    <meta charset="utf-8" />
    <title>Utilities | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Background Color</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Background Gradient Color</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Soft background</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Color & background</h4>
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Background Opacity</h4>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Text Opacity Color</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Additive(Add) Border</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Subtractive(Remove) Border</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Border Color</h4>
                                ...
                                <div class="mb-4">
                                    <h4 class="fs-16">Border Width Size</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Border Opacity</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-12">
                                <div class="mb-4">
                                    <h4 class="fs-16">Border subtle Color</h4>
                                    <p class="text-muted fs-14">Change the border color using utilities built on our theme colors.</p>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Border Radius</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Border Radius Size</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Text Selection</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Pointer Events</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Position in Arrange</h4>
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Position in Center</h4>
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <h4 class="fs-16">Position in Axis</h4>
