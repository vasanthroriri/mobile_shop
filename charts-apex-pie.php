...
<head>
    <meta charset="utf-8" />
    <title>Apex Pie Charts | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Simple Pie Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Simple Donut Chart</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Monochrome Pie Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Gradient Donut Chart</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Patterned Donut Chart</h4>
                                <div dir="ltr">
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Pie Chart with Image fill</h4>
                                <div dir="ltr">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16 mb-4">Donut Update</h4>
                                <div dir="ltr">
