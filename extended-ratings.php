...
<head>
    <meta charset="utf-8" />
    <title>Ratings | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Default Ratings</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Icon Font - Change icon</h4>
                                <p class="text-muted fs-14"></p>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Progressive enhancement (using select)</h4>
                                <p class="text-muted fs-14"></p>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Javascript interaction</h4>
                                <p class="text-muted fs-14"></p>
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Icon Font - Sizing</h4>
                                <p class="text-muted fs-14"></p>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Readonly and preset value</h4>
                                <p class="text-muted fs-14"></p>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Setting and Getting values</h4>
