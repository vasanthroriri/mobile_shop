...
<head>
    <meta charset="utf-8" />
    <title>Popovers | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Simple Popover</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Dismiss on Next Click</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Four Directions</h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Custom Popovers </h4>
                            ...
                            <div class="mb-4">
                                <h4 class="fs-16">Disabled Elements</h4>
