...
<head>
    <meta charset="utf-8" />
    <title>Avatars | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row g-4">
                        <div class="col-xxl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Sizing - Images</h4>
                        ...
                        <div class="col-xxl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Rounded Circle</h4>
                                <p class="text-muted fs-14 mb-3">
                    ...
                    <div class="row g-4">
                        <div class="col-xxl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Sizing - Background Color</h4>
                                <p class="text-muted fs-14 mb-3">
                        ...
                        <div class="col-xxl-6">
                            <div class="mb-4">
                                <h4 class="fs-16">Rounded Circle Background</h4>
                                <p class="text-muted fs-14 mb-3">
                                    Using an additional class <code>.rounded-circle</code> in <code>&lt;img&gt;</code> element creates the rounded avatar.
                                </p>
                    ...
                    <div class="row g-4">
                        <div class="col-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Images Shapes</h4>
                                <p class="text-muted fs-14 mb-3">
                    ...
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="mb-4">
                                <h4 class="fs-16">Avatar Group</h4>
                                <p class="text-muted fs-14 mb-3">
