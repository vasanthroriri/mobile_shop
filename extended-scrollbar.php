...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Scrollbar | Powerx - Bootstrap 5 Admin & Dashboard Template</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row g-4">
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <div class="pb-0">
                                        <h4 class="fs-16">Scroll Size</h4>
                                        <p class="text-muted fs-14">Just use data attribute <code>data-simplebar</code>
                                            and add <code>max-height: **px</code> oh fix height</p>
                                    </div> <!-- end card-body -->

                                    <div class="py-0 mb-3" data-simplebar data-simplebar-lg
                                        style="max-height: 250px;">
                                        SimpleBar does only one thing: replace the browser's default scrollbar
                                        with a custom CSS-styled one without losing performances.
                                        Unlike some popular plugins, SimpleBar doesn't mimic scroll with
                            ...
                            <div class="col-xl-6">
                                <div class="mb-4">
                                    <div class="pb-0">
                                        <h4 class="fs-16">Scroll Color</h4>
                                        <p class="text-muted fs-14">Just use data attribute
                                            <code>data-simplebar data-simplebar-primary</code>
                                            and add <code>max-height: **px</code> oh fix height</p>
                                    </div> <!-- end card-body -->
                                    <div class="py-0 mb-3" data-simplebar data-simplebar-primary
                                        style="max-height: 250px;">
                                        SimpleBar does only one thing: replace the browser's default scrollbar
                                        with a custom CSS-styled one without losing performances.
                                        Unlike some popular plugins, SimpleBar doesn't mimic scroll with
